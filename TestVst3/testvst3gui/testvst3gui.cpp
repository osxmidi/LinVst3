   ...
   std::string command = "./testvst3-batch ";
...
int main (int argc, char *argv[])
{
  ...
  spacertext2 = gtk_label_new ("Choose vst3 dll folder");
  
  folderselect = gtk_file_chooser_button_new ("Choose vst3 dll Folder", GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER);
