...
BUILD_FLAGS  = -std=c++14 -fPIC -DLVRT -DEMBED -DEMBEDDRAG -DVESTIGE -DXECLOSE -DDOUBLEP $(CXX_FLAGS)
...
lin-vst3-server.exe: lin-vst-server.wine.o remotepluginserver.wine.o paths.wine.o
	$(WINECXX) $^ $(LINK_WINE) -o $@
