...
BUILD_FLAGS  = -std=c++14 -fPIC -m64 -O2 -DLVRT -DEMBED -DEMBEDDRAG -DTRACKTIONWM -DVESTIGE -DNEWTIME -DINOUTMEM -DCHUNKBUF -DEMBEDRESIZE -DPCACHE $(CXX_FLAGS)
...
lin-vst3-servertrack.exe: lin-vst-server.wine.o remotepluginserver.wine.o paths.wine.o memorystream.wine.o basewrapper.wine.o 
	$(WINECXX) $^ $(LINK_WINE) -o $@
